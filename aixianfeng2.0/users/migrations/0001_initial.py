# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-05-07 07:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('typesort', models.ImageField(default=1, upload_to='')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.Goods')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='order',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.OrderModel'),
        ),
        migrations.AddField(
            model_name='cartmodel',
            name='goods',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.Goods'),
        ),
        migrations.AddField(
            model_name='cartmodel',
            name='user',
